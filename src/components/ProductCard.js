...
export default function ProductCard({cardData}) {
    ...
    return (
        <div style={{ maxWidth: "240px" , margin:'10px'}}>
            <div> <span style={{ backgroundColor: 'black', color: 'white', fontSize: '15px', float: 'right' }}>Free shipping</span> </div>
            <img src={cardData.details.image} style={{width:'100%',height:'300px' }} />
            ...
            <p style={{ textAlign: 'center' }}>{cardData.details.price}</p>
